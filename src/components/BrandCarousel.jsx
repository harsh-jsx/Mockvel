      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-20 lg:mb-28">
          ...
          <p className="mt-6 text-muted-foreground text-lg max-w-2xl mx-auto">
            Award-winning work recognized by the world's most prestigious design
          ...
          >
            ...
            >
              ...
              <div className="logos-group flex items-center gap-16 lg:gap-24 pr-16 lg:pr-24 flex-shrink-0">
                {AWARDS.map((award, i) => (
                  <div key={`a-${i}`} className="group relative flex-shrink-0">
              ...
              >
                {AWARDS.map((award, i) => (
                  <div key={`b-${i}`} className="group relative flex-shrink-0">
                    <div className="absolute inset-0 bg-primary/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 scale-150" />
        ...
        <div className="mt-20 lg:mt-28 text-center">
          ...
          <button className="group relative inline-flex items-center gap-4 px-10 py-5 bg-primary text-primary-foreground rounded-full overflow-hidden transition-all duration-500 hover:shadow-lg hover:shadow-primary/25">
